...
public class ElementMotxilla<E> {
    ...
    private final double weigth1;
    private final double weigth2;
    ...
    /**
     * D'un conjunt d d'elements per a la motxilla  calcula el profit total
    ...
    /**
     * D'un conjunt d'elements per a la motxilla calcula el weight1 total
     * @param result conjunt d'elements per a la motxilla
    ...
    /**
     * D'un conjunt d'elements per a la motxilla calcula el weight2 total
     * @param result conjunt d'elements per a la motxilla
